...
namespace MegaNote.Database1DataSet1TableAdapters {
    ...
    public partial class NotesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Notes] ([title], [message]) VALUES (@title, @message);\r\nSELECT" +
                " Id, title, message FROM Notes WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Notes] SET [title] = @title, [message] = @message WHERE (([Id] = @O" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MegaNote.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        public virtual int Fill(Database1DataSet1.NotesDataTable dataTable) {
        ...
        public virtual Database1DataSet1.NotesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.NotesDataTable dataTable = new Database1DataSet1.NotesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.NotesDataTable dataTable) {
        ...
        public virtual int Update(string title, string message, int Original_Id, int Id) {
            if ((title == null)) {
                throw new global::System.ArgumentNullException("title");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string title, string message, int Original_Id) {
            return this.Update(title, message, Original_Id, Original_Id);
        }
    }
